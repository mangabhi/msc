      ...
      <div className="container relative mx-auto px-6 py-24 md:py-32">
        <div className="grid items-center gap-12 md:grid-cols-2">
          ...
          <div className="space-y-8">
            ...
            >
              A community platform designed by students, for students. Share knowledge, find study partners, and build lasting connections.
            </p>
            ...
            >
              ...
              <span>Join <span className="font-medium text-foreground">2,000+</span> students already on the platform</span>
            </div>
          </div>
          ...
          >
            ...
            <div className="absolute -bottom-6 -left-6 h-32 w-32 rounded-xl bg-primary/10 animate-float" style={{ animationDelay: '1s' }}></div>
          </div>
        </div>
      </div>
